...
pred.tau_rel <- (tau_varT/(mu_varX^2)) + ((mu_varT^2 * tau_varX)/mu_varX^4) + ((2*mu_varT*(tau_varT^2 - .5*(tau_varE^2)))/mu_varX^3)
...
ggplot() +
  geom_point(aes(x = pred.tau_rel, y = DF$tau_rel), alpha = .1,
